...
<!-- Favicon  -->
<link rel="shortcut icon" type="image" href="ico.png">
...
<div id="mobile-menu">
  ...
  <ul>
    <li><a href="index-2.html" class="home1">Home</a>
...
<div id="page">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-4 col-md-3 col-xs-12">
            <!-- Header Logo -->
            <div class="logo"><a title="MAXSEGURIDAD" href="index-3.html"><img alt="e-commerce" src="images/logo_max_seguridad.png"></a> </div>
            <!-- End Header Logo -->
          </div>
          <div class="col-md-9 col-sm-8 hidden-xs">
            <div class="mtmegamenu">
              ...
              <div class="call-us hidden-sm"> <i class="fa fa-phone"></i>
                <div class="call-us-inner"> <span class="call-text">Servicio al Cliente</span> <span class="call-num">Llamar al: 240-1212 / 715-1487</span> </div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="mega-container visible-lg visible-md visible-sm">
            <div class="navleft-container">
              ...
              <div class="mega-menu-category">
                <ul class="nav">
                  <li> <a href="#">👞   Protección de Pies</a>
                    <div class="wrap-popup column2">
                      <div class="popup">
                        <div class="row">
                          <div class="col-sm-6">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">BOTAS DE PVC</a> </li>
                              <li> <a href="shop_grid-2.html">BOTAS DE JEBE</a> </li>
                              <li> <a href="shop_grid.html">PUNTERAS REMOVIBLES</a> </li>
                            </ul>
                          </div>
                          <div class="col-sm-6 has-sep">

                            <ul class="nav">
                              <li> <a href="shop_grid.html">CUBRE CALZADO DESC.</a> </li>
                              <li> <a href="shop_grid.html">ESCARPINES</a> </li>
                              <li> <a href="shop_grid.html">BORCEGUIS </a> </li>

                            </ul>
                          </div>
                          <div class="col-sm-12"> <a class="img-producto" href="#"><img class="img-responsive" src="images/botas.jpg" alt=""></a> </div>
                        </div>
                      </div>
                    </div>
                  </li>
                  <li> <a href="#">👕 Protección de Cuerpo</a>
                    <div class="wrap-popup column2">
                      <div class="popup">
                          <div class="row">
                            <div class="col-sm-6">
                              <ul class="nav">
                                <li> <a href="shop_grid.html">PANTALON DENIM</a> </li>
                                <li> <a href="shop_grid-2.html">PANTALON DRILL</a> </li>
                                <li> <a href="shop_grid.html">CAMISA DENIM</a> </li>
                                <li> <a href="shop_grid.html">CAMISA DRILL</a> </li>
                                <li> <a href="shop_grid.html">GUADAPOLVOS</a> </li>
                                <li> <a href="shop_grid.html">MAMELUCOS</a> </li>
                                <li> <a href="shop_grid.html">UNIFORMES</a> </li>
                              </ul>
                            </div>
                            <div class="col-sm-6 has-sep">
                              <ul class="nav">
                                <li> <a href="shop_grid.html">FAJA LUMBAR</a> </li>
                                <li> <a href="shop_grid.html">CHALECOS</a> </li>
                                <li> <a href="shop_grid.html">CAMISAS OXFORD </a> </li>
                                <li> <a href="shop_grid.html">POLOS</a> </li>
                                <li> <a href="shop_grid.html">CASACAS</a> </li>
                                <li> <a href="shop_grid.html">ABRIGOS </a> </li>
                                <li> <a href="shop_grid.html">PONCHOS </a> </li>
                              </ul>
                            </div>
                            <div class="col-sm-12"> <a class="img-producto" href="#"><img class="img-responsive" src="images/cuerpo.jpg" alt=""></a> </div>
                          </div>
                      </div>
                    </div>
                  </li>
                  <li><a href="#">✋ Protección de Manos</a>
                    <div class="wrap-popup column2">
                      <div class="popup">
                        <div class="row">
                          <div class="col-sm-6">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">GUANTES SINTETICOS</a> </li>
                              <li> <a href="shop_grid-2.html">GUANTES TEJIDOS</a> </li>
                            </ul>
                          </div>
                          <div class="col-sm-6 has-sep">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">GUANTES DE CUERO</a> </li>
                            </ul>
                          </div>
                          <div class="col-sm-12"> <a class="img-producto" href="#"><img class="img-responsive" src="images/manos.jpg" alt=""></a> </div>
                        </div>
                      </div>
                    </div>
                  </li>
                  <li> <a href="shop_grid.html">👷 Protección de Cabeza</a>
                    <div class="wrap-popup column2">
                      <div class="popup">
                        <div class="row">
                          <div class="col-sm-6">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">CASCOS</a> </li>
                              <li> <a href="shop_grid-2.html">GORRAS DESECHABLES</a> </li>
                              <li> <a href="shop_grid.html">GORRAS EN DRILL</a> </li>
                            </ul>
                          </div>
                          <div class="col-sm-6 has-sep">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">CAPUCHAS EN DRILL</a> </li>
                              <li> <a href="shop_grid.html">SUSPENSIONES</a> </li>

                            </ul>
                          </div>
                          <div class="col-sm-12"> <a class="img-producto" href="#"><img class="img-responsive" src="images/cabeza.jpg" alt=""></a> </div>
                        </div>
                      </div>
                    </div>
                  </li>
                  <li> <a href="shop_grid.html">🎧 Protección de Oido</a>
                    <div class="wrap-popup column2">
                      <div class="popup">
                        <div class="row">
                          <div class="col-sm-6">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">TAPONES DE OIDO</a> </li>
                              <li> <a href="shop_grid-2.html">OREJERA TIPO VINCHA</a> </li>
                            </ul>
                          </div>
                          <div class="col-sm-6 has-sep">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">OREJERA ADAPTABLE AL CASCO</a> </li>

                            </ul>
                          </div>
                          <div class="col-sm-12"> <a class="img-producto" href="#"><img class="img-responsive" src="images/oidos.jpg" alt=""></a> </div>
                        </div>
                      </div>
                    </div>
                  </li>
                  <li><a href="#">👃 Protección Respiratoria</a>
                    <div class="wrap-popup column2">
                      <div class="popup">
                        <div class="row">
                          <div class="col-sm-6">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">CARA COMPLETA</a> </li>
                          ...
                          <div class="col-sm-6 has-sep">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">CARTUCHOS</a> </li>
                              <li> <a href="shop_grid.html">FILTROS</a> </li>

                            </ul>
                          </div>
                          <div class="col-sm-12"> <a class="img-producto" href="#"><img class="img-responsive" src="images/respiratorio.jpg" alt=""></a> </div>
                        </div>
                      </div>
                    </div>
                  </li>
                  <li><a href="shop_grid.html">👓 Protección de Ojos</a>
                    <div class="wrap-popup column2">
                      <div class="popup">
                        <div class="row">
                          <div class="col-sm-6">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">LENTES CLASICOS</a> </li>
                          ...
                          <div class="col-sm-6 has-sep">
                            <ul class="nav">
                              <li> <a href="shop_grid.html">LENTES DE SOLDADOR</a> </li>

                            </ul>
                          </div>
                          <div class="col-sm-12"> <a class="img-producto" href="#"><img class="img-responsive" src="images/visual.jpg" alt=""></a> </div>
                        </div>
                      </div>
                    </div>
                  </li>
                  <li class="nosub"><a href="shop_grid.html">⚠️ Protección de Caidas</a></li>
                  <li class="nosub"><a href="shop_grid.html">🕶️ Protección Facial</a></li>
                  <li class="nosub"><a href="shop_grid.html">🚸 Protección Vial</a></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="tp-banner" >
        <ul>
          ...
          <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="Intro Slide">
            <!-- MAIN IMAGE -->
            <img src="images/slider/1.jpg"  alt="slidebg1" data-lazyload="images/slider/1.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
            ...
            <div class="tp-caption small_text lft tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 7;  white-space: nowrap; font-size:24px; font-weight:500; color:#fff; background-color:#f4a137; padding:15px 25px;">Protección en Trabajo de Construcción </div>


          </li>
          <!-- SLIDE  -->
          <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="Ken Burns Slide">
            <!-- MAIN IMAGE -->
            ...
            <div class="tp-caption small_text lft tp-resizeme rs-parallaxlevel-0"
								...
								data-endelementdelay="0.1"
								style="z-index: 9; white-space: nowrap; font-size:24px; font-weight:500; color:#fff; background-color:#f4a137; padding:15px 25px;"><span>Protección para Trabajo en Soldadura</span> </div>
          ...
          <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="Parallax 3D">
            <!-- MAIN IMAGE -->
            <img src="images/slider/3.jpg"  alt="3dbg" data-lazyload="images/slider/3.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
            ...
            <div class="tp-caption small_text lft tp-resizeme rs-parallaxlevel-0"
                 ...
                 data-elementdelay="0.05"
                 data-endelementdelay="0.1"
                 style="z-index: 9; white-space: nowrap; font-size:24px; font-weight:500; color:#fff; background-color:#f4a137; padding:15px 25px;"><span>Protección para Trabajo en Altas Temperaturas</span> </div>
          </li>
          <!-- SLIDE  -->
          <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="Parallax 3D">
            <!-- MAIN IMAGE -->
            <img src="images/slider/4.jpg"  alt="3dbg" data-lazyload="images/slider/4.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
            ...
            <div class="tp-caption small_text lft tp-resizeme rs-parallaxlevel-0"
                 ...
                 data-elementdelay="0.05"
                 data-endelementdelay="0.1"
                 style="z-index: 9; white-space: nowrap; font-size:24px; font-weight:500; color:#fff; background-color:#f4a137; padding:15px 25px;"><span>Protección para Trabajo en Derrames Químicos</span> </div>
          </li>
                ...
                <div id="special-products-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col4">
                        <div class="product-item">
                            <div class="item-inner">
                                <div class="product-thumb has-hover-img"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                        <figure> <img src="images/products/img06.jpg" alt=""> <img class="hover-img" src="images/products/img06.jpg" alt=""></figure>
                                    </a>
                                    <div class="pr-info-area animated animate4"><a href="quick_view.html" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" class="wishlist"><i class="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" class="compare"><i class="fa fa-exchange"><span>Compare</span></i></a> </div>
                                </div>
                                <div class="item-info">
                        ...
                        <div id="special-products-slider" class="product-flexslider hidden-buttons">
                            <div class="slider-items slider-width-col4">
                                <div class="product-item">
                                    <div class="item-inner">
                                        <div class="product-thumb has-hover-img"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                                <figure> <img src="images/products/img11.jpg" alt=""> <img class="hover-img" src="images/products/img11.jpg" alt=""></figure>
                                            </a>
                                            <div class="pr-info-area animated animate4"><a href="quick_view.html" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" class="wishlist"><i class="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" class="compare"><i class="fa fa-exchange"><span>Compare</span></i></a> </div>
                                        </div>
                                        <div class="item-info">
                        ...
                        <div id="special-products-slider" class="product-flexslider hidden-buttons">
                            <div class="slider-items slider-width-col4">
                                <div class="product-item">
                                    <div class="item-inner">
                                        <div class="product-thumb has-hover-img"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                                <figure> <img src="images/products/img16.jpg" alt=""> <img class="hover-img" src="images/products/img16.jpg" alt=""></figure>
                                            </a>
                                            <div class="pr-info-area animated animate4"><a href="quick_view.html" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" class="wishlist"><i class="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" class="compare"><i class="fa fa-exchange"><span>Compare</span></i></a> </div>
                                        </div>
                                        <div class="item-info">
                                ...
                                <div class="product-item">
                                    <div class="item-inner">
                                        <div class="product-thumb has-hover-img"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                                <figure> <img class="first-img" src="images/products/img17.jpg" alt=""> <img class="hover-img" src="images/products/img17.jpg" alt=""></figure>
                                            </a>
                                            <div class="pr-info-area animated animate4"><a href="quick_view.html" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" class="wishlist"><i class="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" class="compare"><i class="fa fa-exchange"><span>Compare</span></i></a> </div>
                                        </div>
                                        <div class="item-info">
                                ...
                                <div class="product-item">
                                    <div class="item-inner">
                                        <div class="product-thumb has-hover-img"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                                <figure> <img class="first-img" src="images/products/img18.jpg" alt=""> <img class="hover-img" src="images/products/img18.jpg" alt=""></figure>
                                            </a>
                                            <div class="pr-info-area animated animate4"><a href="quick_view.html" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" class="wishlist"><i class="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" class="compare"><i class="fa fa-exchange"><span>Compare</span></i></a> </div>
                                        </div>
                                        <div class="item-info">
                                ...
                                <div class="product-item">
                                    <div class="item-inner">
                                        ...
                                        <div class="product-thumb has-hover-img"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                                <figure> <img class="first-img" src="images/products/img19.jpg" alt=""> <img class="hover-img" src="images/products/img19.jpg" alt=""></figure>
                                            </a>
                                            <div class="pr-info-area animated animate4"><a href="quick_view.html" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" class="wishlist"><i class="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" class="compare"><i class="fa fa-exchange"><span>Compare</span></i></a> </div>
                                        </div>
                                        <div class="item-info">
                                ...
                                <div class="product-item">
                                    <div class="item-inner">
                                        <div class="product-thumb has-hover-img">
                                            <a title="Ipsums Dolors Untra" href="single_product.html">
                                                <figure> <img class="first-img" src="images/products/img20.jpg" alt=""> <img class="hover-img" src="images/products/img20.jpg" alt=""></figure>
                                            </a>
                                            <div class="pr-info-area animated animate4"><a href="quick_view.html" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" class="wishlist"><i class="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" class="compare"><i class="fa fa-exchange"><span>Compare</span></i></a> </div>
                                        </div>
                                        <div class="item-info">
  ...
  <footer>
          ...
          <div class="slider-items-products">
            <div id="our-clients-slider" class="product-flexslider hidden-buttons">
              <div class="slider-items slider-width-col6">
                ...
                <!-- Item -->
                <div class="item"> <a href="#"><img src="images/brand/brand1.png" alt="Image"></a> </div>
                <!-- End Item -->

                <!-- Item -->
                <div class="item"> <a href="#"><img src="images/brand/brand2.png" alt="Image"></a> </div>
                <!-- End Item -->

                <!-- Item -->
                <div class="item"> <a href="#"><img src="images/brand/brand3.png" alt="Image"></a> </div>
                <!-- End Item -->

                <!-- Item -->
                <div class="item"> <a href="#"><img src="images/brand/brand4.png" alt="Image"></a> </div>
                <!-- End Item -->
                <!-- Item -->
                <div class="item"> <a href="#"><img src="images/brand/brand5.png" alt="Image"></a> </div>
                <!-- End Item -->

                <!-- Item -->
                <div class="item"> <a href="#"><img src="images/brand/brand6.png" alt="Image"></a> </div>
                <!-- End Item -->

                <!-- Item -->
                <div class="item"> <a href="#"><img src="images/brand/brand7.png" alt="Image"></a> </div>
                <!-- End Item -->
    ...
    <div class="footer-coppyright">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-xs-12 coppyright"> Copyright © 2017 <a href="#"> MAXSEGURIDAD </a>. All Rights Reserved. </div>
